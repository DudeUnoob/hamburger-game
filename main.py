...
hamburger_image = pygame.image.load(current_directory + "\hamburger.jpg").convert()
lettuce_image = pygame.image.load(current_directory + "\lettuce.jpg").convert_alpha()
tomato_image = pygame.image.load(current_directory + "\omato.jpg").convert_alpha()
cheese_image = pygame.image.load(current_directory + "\cheese.jpg").convert_alpha()
